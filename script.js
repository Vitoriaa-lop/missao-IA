        ...
        alternativas: [
            {
                ...
                afirmacao: [
                    "PERFIL DO QUADRANTE: A rotina extrema no Quadrante dos Cavaleiros e a alta taxa de mortalidade entre os aspirantes.",
                    "PERFIL DO QUADRANTE: Bastidores da sobrevivência em Basgiath e o preço de sangue pago para se tornar um Cavaleiro."
                ]
            },
            {
        ...
        alternativas: [
            {
                ...
                afirmacao: [
                    "DOSSIÊ POLÍTICO: A verdade sobre a guerra entre Navarra e Poromiel e a conspiração para esconder o avanço do inimigo real.",
                    "DOSSIÊ POLÍTICO: Mapeamento detalhado das fronteiras e das mentiras contadas aos cidadãos para manter o controle."
                ]
            },
            {
                texto: "O Véu de Proteção (Wards) e os Venin - A magia das pedras de proteção contra as forças escuras que drenam a terra.",
                afirmacao: [
                    "DOSSIÊ POLÍTICO: As falhas no véu de proteção de Basgiath e a terrível ameaça dos Venin e dos Wyrm que drenam a magia do solo.",
                    "DOSSIÊ POLÍTICO: O funcionamento da magia de proteção ancestral e o perigo iminente caso as barreiras venham a ruir."
                ]
            }
        ]
    },
